...
echo "  <div class='right rtxt'>
                ...
                <div class='txt'>
                    ...
                    should be directed to <a href='mailto:ejf39@cornell.edu'>Eric Fish</a>.</div>";
                    if(!isset($_GET['a'])){
                        echo "
                            ...
                            <div class='entry'>
                                <div class='p'>Please let us know how you heard about our scholarship.</div>
                        ...
                        if(mail("acacia@cornell.edu", "Scholarship Application",
...
Heard about the scholorship: {$_POST['heard']}",
																	"To: Eric Fish <acacia@cornell.edu>\r\n" .
